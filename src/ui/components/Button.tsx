...
function buttonClasses(variant: ButtonVariant, className: string) {
  const base =
    "inline-flex items-center justify-center rounded-component px-3 py-2 text-sm font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-canvas disabled:cursor-not-allowed disabled:opacity-50";
